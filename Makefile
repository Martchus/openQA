...
test-scheduler:
	$(MAKE) test-with-database SCHEDULER_FULLSTACK=1 SCALABILITY_TEST= PROVE_ARGS="$$HARNESS t/05-scheduler-full.t t/43-scheduling-and-worker-scalability.t" RETRY=3
